...
const upload = multer({ storage }).single('profile_picture'); // Assuming 'file' is the name attribute in the form
...
module.exports = { index, store, getOne, search, update, destroy,upload, storingValidation };
